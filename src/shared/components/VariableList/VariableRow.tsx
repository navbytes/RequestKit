...
interface VariableRowTabletProps {
  ...
  renderActionButtons: (variable: Variable) => ReactNode;
  renderScopeTag: (variable: Variable) => ReactNode;
}

interface VariableRowProps extends VariableRowTabletProps {
  renderValueDisplay: (variable: Variable) => ReactNode;
}
    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-sm text-gray-600 dark:text-gray-400">
          Usage: {variable.metadata?.usageCount || 0}
        </div>
      </div>
